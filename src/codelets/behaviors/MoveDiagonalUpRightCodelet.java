 ...
 * @author leticia
 */
public class MoveDiagonalUpRightCodelet extends Codelet{
    ...
    public void proc() {
        ...
        if (!actionsWinnerList.isEmpty()){
            ...
            if(sizeAct != tamActionMO){
                ...
                if (actionToTake.equals("DiagonalUpRight")){
                    eval = 1.0;  
                }
                JSONMessageToMO("DiagonalUpRight");
            }
        }
    }//fim proc
     ...
     void JSONMessageToMO(String actionToTake){
        ...
        double angular_velocity = -speed/10;//Para virar para a direita
        ...
        //System.out.println("DiagUpRight " + eval);
